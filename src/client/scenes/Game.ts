...
export class Game extends Scene {
  ...
  create() {
    ...
    this.petGlow = this.add.circle(CENTER_X, PET_CENTER_Y, PET_GLOW_RADIUS, 0xff6b4a, 0.18);
    ...
    this.add
      .text(CENTER_X, LEADERBOARD_Y - LEADERBOARD_H / 2 + 30, '🏆  TOP VOTERS', {
        fontFamily: 'Arial Black',
        fontSize: 15,
        color: '#ffd23f',
      })
